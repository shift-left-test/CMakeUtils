...
class BuildResult:
    ...
    def noErrors(self):
        cmake_status = self.cmake.stderr.empty()
        make_status = self.make.stderr.empty()
        test_status = self.test.stderr.empty() or self.test.stderr.contains("No tests were found!!!")
        return cmake_status and make_status and test_status
